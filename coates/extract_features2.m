function XC = extract_features2(X, centroids, PatchWidth, PatchHeight, CIFAR_DIM, M,P)
%assert(nargin == 4 || nargin == 6);
  ...
  for i=1:size(X,1)
    ...
    patches = [ im2col(reshape(X(i,1:1024),CIFAR_DIM(1:2)), [PatchWidth ...
                   PatchHeight]) ;
    ...
    prows = CIFAR_DIM(1)-PatchHeight+1;
    pcols = CIFAR_DIM(2)-PatchWidth+1;
